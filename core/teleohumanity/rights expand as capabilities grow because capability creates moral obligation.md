...
Relevant Notes:
- [[collective superintelligence is the alternative to monolithic AI controlled by a few]] -- the capability expansion that would trigger the largest obligation expansion in history
- [[the future is a probability space shaped by choices not a destination we approach]] -- capability creates obligation precisely because the future is shaped by choices
- [[early action on civilizational trajectories compounds because reality has inertia]] -- expanding rights early compounds because each expansion becomes the new baseline
