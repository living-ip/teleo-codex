---
type: source
title: "Futardio: Seyf fundraise goes live"
author: "futard.io"
url: "https://www.futard.io/launch/2TK2hDtyNAY2hbV3yHDoVaAPSfaod2sHX7PtWPz8QfmQ"
date: 2026-03-05
...
## Launch Details
- Project: Seyf
- Description: The first AI-native wallet for Solana, where you set the goal — and the agent executes it.
...
# Seyf  
### The First AI-Native Wallet for Solana
...
- Manually selecting tokens  
- Copying and verifying wallet addresses  
- Configuring slippage  
- Switching between DeFi protocols  
...
2. Converts it into structured on-chain instructions  
3. Displays a secure transaction preview  
4. Executes only after explicit confirmation  
...
# Use of Funds ($500,000 Raise Target)
...
## Team (Lean Core Structure)

- **1 AI Engineer** – LLM orchestration, intent parsing, agent logic  
- **1 Backend Engineer** – execution engine, wallet infrastructure, risk engine  
- **1 Frontend Engineer** – wallet interface, transaction preview, UX  
- **1 Product & Growth Lead** – strategy, partnerships, growth  
...
- AI Engineer — ~$4,500  
- Backend Engineer — ~$4,500  
- Frontend Engineer — ~$3,500  
- Product & Growth Lead — ~$3,500  
...
### Marketing & Growth — ~$3,000 / month

- Solana ecosystem outreach  
- Partnerships  
- Referral campaigns  
...
- Sufficient time for iteration  
- Revenue generation before the next raise  
...
- SPL token whitelist system  
- Secure transaction preview  
- Closed beta launch  

**Target Outcomes:**
- 1,000 users  
- $5M cumulative transaction volume  
...
- Loss limits and safeguards  
- Security audit  

**Target Outcomes:**
- 10,000 users  
- $25M cumulative volume  

---

## Phase 3 — AI Expansion (Months 7–12)
...
1. **Intent-Based UX**  
2. **Secure Architecture (AI never holds private keys)**  
3. **Deep Solana Integration**  
4. **Built-in Risk Engine**  
5. **Scalable Toward AI-Agent Infrastructure**  

---

# Go-To-Market Strategy

- Launch within Solana-native communities  
- Partnerships with DEX platforms  
