...
- **2024-08-07** — [[metadao-approve-q3-roadmap]] passed: Q3 roadmap approved focusing on market-based grants product launch, SF team building, and UI performance improvements (14.6s → 1s page load target)
## Key Decisions
